...
echo "Testing api..."
curl -X POST -H "x-ha-access: Chopan88" -H "Content-Type: application/json" -d '{"device_id": 17, "button_id": 8 }' http://hassio/homeassistant/api/events/lutron_button_pressed
